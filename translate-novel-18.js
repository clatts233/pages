...
// @updateURL    https://clatts233.github.io/static/translate-novel-18.js
// @downloadURL  https://clatts233.github.io/static/translate-novel-18.js
// @version      0.1
// @description  novel18翻译插件
// @author       clatts
...
setTimeout(() => {
    (function () {
        ...
        /** openai的appKey，必须 */
        const OPENAI_APP_KEY = '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';
        /** 分块翻译最大字数 */
        ...
        class Novel18Translate {
            ...
            addTranslateBtn() {
                const controls = document.querySelector('#novel_honbun');
            ...
            async translateWithEl() {
                const novelTextContainer = document.querySelector('#novel_honbun');
                ...
                const queue = new RequestQueue(new Array(paragraphList.length).fill(0).map((_, i) => {
                    return async () => {
                        ...
                        paragraph.style.paddingBottom = '22px';
